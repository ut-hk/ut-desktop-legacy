...
export class App_ratingApi {
     ...
     * 
     */
    public appRatingGetRatings(extraHttpRequestParams?: any): Observable<models.GetRatingsOutput> {
        return this.appRatingGetRatingsWithHttpInfo(extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * 
     */
    public appRatingGetRatingsWithHttpInfo(extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/api/services/app/rating/GetRatings`;
