...
export class App_activityTemplateApi {
     ...
     * @param input 
     */
    public appActivityTemplateRemoveActivityTemplate(input: models.EntityDtoGuid, extraHttpRequestParams?: any): Observable<{}> {
        return this.appActivityTemplateRemoveActivityTemplateWithHttpInfo(input, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param input 
     */
    public appActivityTemplateRemoveActivityTemplateWithHttpInfo(input: models.EntityDtoGuid, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/api/services/app/activityTemplate/RemoveActivityTemplate`;

        let queryParameters = new URLSearchParams();
        let headers = new Headers(this.defaultHeaders.toJSON()); // https://github.com/angular/angular/issues/6845
        // verify required parameter 'input' is not null or undefined
        if (input === null || input === undefined) {
            throw new Error('Required parameter input was null or undefined when calling appActivityTemplateRemoveActivityTemplate.');
        }
        // to determine the Content-Type header
        let consumes: string[] = [
        ];
